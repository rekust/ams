...
$str = "select u.user_id, u.email, s.student_name, s.father_name, s.mother_name, s.phone, s.roll_number, s.rank, TIMESTAMPDIFF(YEAR, s.DOB, CURDATE()) AS age, s.DOB, s.aadhaar, s.PRTC, s.marksheet, s.admit_card, s.birth_certificate, s.caste_certificate from students s join user u using(user_id) where s.status_id=3;";
...
<body>
  ...
  <p class="list-header">Rejected Student List</p>
  <div class="container">
      ...
      <div class="student">
        <div class="student-card">
          ...
          <div class="btn-wrapper">
            ...
            <div class="btn">
              <form action="../php/status_r.php" method="post" id="my-form-<?php echo $row['user_id'] ?>">
